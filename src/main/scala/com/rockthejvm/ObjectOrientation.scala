...
object ObjectOrientation extends App {
  ...
  // inheritance
  private class Dog(name: String) extends Animal {  // constructor definition
  }

  private val aDog = new Dog("Lassie")
  // Constructor arguments are not fields
//  aDog.name

  // To promote to class member, argument must be a val
  class Cat(val name: String) extends Animal {  // constructor definition
  }
  val aCat = new Cat("Chester")
  println(aCat.name)
  ...
  abstract class WalkingAnimal {
    protected val hasLegs = true      // by default public, can restrict by adding private or protected
    def walk() : Unit
  }
  ...
  val dinosaur = new Carnivore {
    override def eat(animal: Animal): Unit = println("I am a dinosaur and I can eat anything")
  }
  ...
  object MySingleton {
    ...
    def apply(x: Int): Int = x + 1      // special functon for all Scala classes
  }

  MySingleton.mySpecialMethod()
  MySingleton.apply(65)
  MySingleton(65)   // equivalent to MySingleTon.apply(65_
  ...
  // Any modfiication to an object must return ANOTHER object
  // Benefits:
